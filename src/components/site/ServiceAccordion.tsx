  ...
  return (
    <ol className="border-t border-border">
      {items.map((s, i) => {
        ...
        const media = serviceMedia[s.id];
        return (
          <li key={s.id} className="group border-b border-border">
            <button
              type="button"
            ...
            >
              <span className="label-mono absolute left-0 top-1/2 -translate-y-1/2">{num}</span>
              <span
              ...
              <div className="overflow-hidden">
                <div className="grid gap-x-12 gap-y-8 pb-14 pt-1 md:grid-cols-11 md:items-center md:pb-16">
                  ...
                  >
                    ...
                    <ul className="mt-7 space-y-3 border-t border-border pt-6">
                      {s.points.map((point) => (
                        <li
                          key={point}
                          className="grid grid-cols-[auto_1fr] gap-x-3 text-sm leading-snug text-muted-foreground"
                        >
                  ...
                  <figure
                    ...
                    style={{
                      transition:
                        "opacity 0.7s cubic-bezier(0.16,1,0.3,1), filter 0.7s cubic-bezier(0.16,1,0.3,1)",
